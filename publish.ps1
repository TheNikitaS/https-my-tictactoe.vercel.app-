...
Invoke-Git add README.md .gitignore index.html publish.ps1 supabase_setup.sql platform_setup.sql platform_owner_patch.sql platform_light2_patch.sql shared moy part prodazhi platform
