...
Invoke-Git add README.md .gitignore index.html publish.ps1 supabase_setup.sql platform_setup.sql platform_owner_patch.sql platform_light2_patch.sql platform_light2_finance_patch.sql platform_light2_assets_purchases_patch.sql platform_first_run.sql shared moy part prodazhi platform
