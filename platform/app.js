...
import { createLiveWorkspaceController } from "./live-workspaces.js?v=20260410-platform-restore39";
import { createDomovoyNeonik } from "./domovoy-neonik.js?v=20260410-platform-restore39";

const SUPABASE_URL = "https://cfmjxssilejlqmsbtbrv.supabase.co";
const SUPABASE_KEY = "sb_publishable_ZLMLOM21dAYfchc7OW9TsA_vjTQ3sB3";
const REDIRECT_URL = window.location.href.split("#")[0];
const PLATFORM_BUILD = "20260410-platform-restore39";
