...
import { createLiveWorkspaceController } from "./live-workspaces.js?v=20260412-platform-suite42";
import { createDomovoyNeonik } from "./domovoy-neonik.js?v=20260412-platform-suite42";

const SUPABASE_URL = "https://cfmjxssilejlqmsbtbrv.supabase.co";
const SUPABASE_KEY = "sb_publishable_ZLMLOM21dAYfchc7OW9TsA_vjTQ3sB3";
const REDIRECT_URL = window.location.href.split("#")[0];
const PLATFORM_BUILD = "20260412-platform-suite42";
