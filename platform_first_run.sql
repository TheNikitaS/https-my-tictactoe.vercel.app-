-- Дом Неона platform first-run bootstrap
-- Run this single file in Supabase SQL Editor for the first launch.
-- It creates the platform schema, owner/admin logic, ДОМ НЕОНА settlements,
-- and promotes n.suhotin@yandex.ru to owner.
